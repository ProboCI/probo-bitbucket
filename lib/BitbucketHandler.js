...
var BitbucketHandler = function(options) {
  ...
  // responds to the action sent by bb
  ...
  // repo:push isn't really needed; pullrequest:updated handles when a pr receives a push.
  ...
  // creating the server if there isn't one to receive messages
  if (!server) {
  ...
  // this is a utility to post data via the server
 ...
 *    {string} state - The status of the build.
 *    {string} description - The text of the status update.
 *    {string} key - Context string returned from bitbucket.
 *    {string} url - The target url.
 * @param {Object} build - The build object, including:
 *    {Object} .project - See postStatusToBitbucket prototype.
 *    {Object} .commit - An object that contains at least .ref, which is the sha for the build.
 ...
 *    {string} .type - The type of request, such as 'pullrequest:created'.
 *    {string} .service - The provider; should be 'bitbucket'.
 *    {string} .slug - The slug of the repo such as 'dzinkevich/cool-project'
 *    {Object} .event - The payload of the event. It is parsed here.
 ...
 *    {string} .repo - The name of the repo, ie 'my-cool-project'.
 ...
 *     {string} .state - The state of the status.
 *     {string} .description - The body of the status.,
 *     {string} .key - A name for the update (max 40 characters).
 *     {string} .url - The URL for the status update.
 * @param {function} done - The callback for after the status has been posted.
 * @return {Object} - The result of the call to done.
 */
 ...
 *    {string} .repo - The repo name, ie 'my-cool-project'.
 *    {string} .owner - The repo owner, ie 'dzinkevich'.
 ...
 * @return {Object} - Either an error or the output from the api call.
 */
...
/**
 * Calculates OAuth2.0 authorization header value for a request
 * @param {Object} req - The request. The refresh token is stored in req.query.refreshToken.
 * @param {Object} res - The response.
 * @param {function} next - The callback that will receive the refresh token.
 */
