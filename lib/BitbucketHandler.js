...
BitbucketHandler.prototype.pushHandler = function(event, cb) {
  ...
  var request = {
    ...
    slug: event.payload.repository.full_name, //new
    commit_url: event.payload.repository.html_url + '/commit/' + event.payload.pull_request.head.sha, //new
    pull_request: event.payload.pull_request.number, //new
    pull_request_id: event.payload.pull_request.id, //new
    pull_request_name: event.payload.pull_request.title, //new
    pull_request_description: event.payload.pull_request.body, //new
    pull_request_html_url: event.payload.pull_request._links.html.href, //new
  };
...
BitbucketHandler.prototype.authLookupController = function(req, res, next) {
  ...
  try {
    ...
    this._validate(req.query, ['path', 'provider_slug'],
